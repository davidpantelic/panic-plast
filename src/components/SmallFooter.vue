<template>
  <footer>
    <div class="bg-brand-black text-brand-yellow w-full flex flex-wrap gap-5 justify-center items-center p-5 text-center">
      ...
      <a href="mailto:dpdavid156@gmail.com" target="_blank" class="hover:rotate-6 transition-all order-3"><img src="@/assets/images/webdak_logo_small.png" :alt="t('footer.webdak_badge_alt')" :title="t('footer.webdak_badge_title')" class="w-20 rounded-full"></a>
    </div>
  </footer>
</template>
